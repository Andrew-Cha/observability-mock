...
@app.get("/cats/")
def get_cats(cursor: Cursor = Depends(get_db_cursor)):
    ...
    for row in cats:
        ...
        result = {"id": id, "name": name, "breed": breed, "age": age}
...
def create_cat(
    ...
    return {"id": cat_id, "name": name, "breed": breed, "age": age}
...
@app.get("/owners/")
def get_owners(cursor: Cursor = Depends(get_db_cursor)):
    ...
    for row in owners:
        ...
        result = {"id": id, "name": name, "address": address, "cat_id": cat_id}
        results.append(result)
...
def create_owner(
    ...
    return {"id": owner_id, "name": name, "address": address, "cat_id": cat_id}
